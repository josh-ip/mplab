...
int main(void)
{
   ...
   //PIN_MANAGER_Initialize();
    ...
    //TIMER_RequestTick(&ChangeColor, 100);
    ...
    */
    ...
    //init();
       // TIMER_RequestTick(UARTSendString(str, 14), 100);
...
//doze 1, 0, and 8
        ...
        {
           // onOrOff = !onOrOff;
            UARTSendString(str, 14);
            //ChangeColor();
//            if (onOrOff){
//                LED_RGB_Set(LED_RGB_LD3, 0, 0, 1023);
//            }
//            else{
//                LED_RGB_Set(LED_RGB_LD3, 0, 0, 0);
//            }
            blink = 1000;
        }
        else{
